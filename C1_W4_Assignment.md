...
<span style="font-size:16px"><b>3.1.</b></span> In the AWS Console, search for **RDS**, and click on the **Aurora and RDS** option. Next, click on **Databases** in the left panel, and find the database called `de-c1w4-vector-db`. 
